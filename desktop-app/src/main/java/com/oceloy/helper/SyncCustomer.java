...
public class SyncCustomer {
    ...
    public static void api_send() {
        ...
        if (connection_status.equals("connected")) {
            ...
            try {
                URL url = new URL(Env.api_url + "get-calibration-customers");
                ...
                if (status.equals("ok")) {
                    Object users_val = jsonKey.get("customers");
                    ...
                    for (int i = 0; i < jsonarray.length(); i++) {
                        ...
                        stmt = con.createStatement();
                        stmt.executeUpdate("INSERT INTO customers (customer_name, sync) VALUES ('" + name + "', 'ok')");
                    }
                }
            } catch (Exception e) {
                e.printStackTrace();
